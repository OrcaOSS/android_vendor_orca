...
PRODUCT_COPY_FILES += \
    vendor/orca/prebuilt/common/etc/init/init.openssh.rc:$(TARGET_COPY_OUT_PRODUCT)/etc/init/init.openssh.rc
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/orca/overlay/no-rro
PRODUCT_PACKAGE_OVERLAYS += \
    vendor/orca/overlay/common \
    vendor/orca/overlay/no-rro
